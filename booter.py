...
# Set window title
print(f"\033]0;Python DDOS V6.0 By nightmarestresser.org\007", end="", flush=True)
...
██. ██ ██. ██ ▐█▌.▐▌▐█▄▪▐█
▀▀▀▀▀• ▀▀▀▀▀•  ▀█▄▀▪ ▀▀▀▀ 
Nightmare Stresser offers a 100% free shared account with access to over 40 Layer 4 and Layer 7 methods, no server or technical expertise required. Visit nightmarestresser.org to get started.
"""
...
def http_post_flood(url, duration):
    ...
    try:
        ...
        print(Fore.RED + f"[❌] Error: {e}")
    print(Fore.GREEN + f"[✅] Done! Sent {request_count} POST requests.") ##made by nightmarestresser.org
...
def http_random_ua_flood(url, duration):
    ...
    user_agents = [
        ...
        "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7) Gecko/20100101", ##nightmarestresser.org
